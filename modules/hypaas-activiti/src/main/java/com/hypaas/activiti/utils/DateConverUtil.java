...
public final class DateConverUtil {
   ...
   * @return Date日期对象
   *     <p>示例：String time="2013-11-01 11:22";
   ...
   * @return 字符串类型
   *     <p>示例：DateConverUtil.dd2(new Date(),DateConverUtil.TimeType.type2.getValue()) 或者
   ...
   * @return 字符串类型
   *     <p>示例：DateConverUtil.dd3("2015-2-11","yyyy年MM月dd日","yyyy-M-dd") ;
   */
